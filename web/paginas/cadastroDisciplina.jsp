  ...
  <div class="py-5">
    <div class="container">
      <div class="row bg-primary text-white">
        <div class="col-md-12">
          <h2 class="text-center"><b>Cadastro de Disciplinas</b><br></h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="${pageContext.request.contextPath}/CadastroDisciplinaServlet">
            <div class="form-group"> <label>Nome</label> <input type="text" class="form-control" name="nomeDisciplina"> </div>
